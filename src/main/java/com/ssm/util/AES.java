...
public class AES {
     ...
     * 3.将加密内容解密
     */
    public static String AESDncode(String salt, String content) {
        try {
            //1.构造密钥生成器，指定为AES算法,不区分大小写
            KeyGenerator keygen = KeyGenerator.getInstance("AES");
            //2.根据ecnodeRules规则初始化密钥生成器
    ...
    public static void main(String[] args) {
        ...
        System.out.println("根据输入的规则" + salt + "加密后的密文是:" + se.AESEncode(salt, content));
        ...
        System.out.println("根据输入的规则" + salt + "解密后的明文是:" + se.AESDncode(salt, content));
    }
